...
if (dataset == 'UrbanTracker'):
    if (detection_method == 'RFCN'):
        ...
        output_file = '/home/huooi/HL_Results/MOT_result/UrbanTracker' + seq_name + 'lll_w_l.xml'
        output_file_filtered = '/home/huooi/HL_Results/MOT_result/UrbanTracker/' + seq_name + 'lll_w_l_filtered.xml'
